...
//     } 
//     RightDrive2Smart.setVelocity(modPercent*pidPercent, percentUnits::pct);
//     RightDrive2Smart.spin(forward);
//     LeftDrive2Smart.setVelocity(modPercent*pidPercent, percentUnits::pct);
//     LeftDrive2Smart.spin(forward);
//     currDist = ((LeftDrive2Smart.position(degrees) + RightDrive2Smart.position(degrees)) / 2) - startPos;
...
//   //left is positive, ew
//   motor_group accurateSide = turnAngle > 0 ? RightDrive2Smart : LeftDrive2Smart; //this is super cursed help
